 ...
 * - name: filter by company name (case-insensitive, partial matches)
 *
 * If minEmployees > maxEmployees, returns 400 error.
 * Only these filter parameters are allowed; others will cause 400 error.
 *
